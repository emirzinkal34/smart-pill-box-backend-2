    ...
    public partial class InitialDatabaseSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaregiverPatients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CaregiverPatients_Users_CaregiverId",
                        column: x => x.CaregiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CaregiverPatients_Users_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Intakes_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaregiverPatients_CaregiverId_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_MedicationId",
                table: "Schedules",
                column: "MedicationId");
